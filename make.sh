...
xmvhdl -work worklib -cdslib ./cds.lib -logfile ncvhdl.log -errormax 15 -update -status -SMARTORDER -v93 -file ./files_vhdl.txt

xmelab -coverage all -v93 -work worklib -cdslib ./cds.lib -logfile ./ncelab.log -errormax 15 -nowarn CUVWSP -nowarn MEMODR worklib.Test -STATUS -NOTIMINGCHECKS -access +RWC -NOSPECIFY

xmsim -gui -cdslib ./cds.lib -logfile ./ncsim.log -errormax 15 -status worklib.Test:lab1
